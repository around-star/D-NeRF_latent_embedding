...
def run_network(inputs, viewdirs, frame_time, fn, embed_fn, embeddirs_fn, embedtime_fn, netchunk=1024*64,
    ...
    outputs_flat, position_delta_flat = batchify(fn, netchunk)(embedded, input_frame_time_flat)
...
def train():
    ...
    if args.render_only:
        ...
        with torch.no_grad():
            ...
            rgbs, _ = render_path(args, render_poses, render_times, hwf, args.chunk, render_kwargs_test, gt_imgs=images,
    ...
    for i in trange(start, N_iters):
        ...
        if i%args.i_video==0 or i == 5000:
            ...
            with torch.no_grad():
                ...
                rgbs, disps = render_path(args, render_poses, render_times, hwf, args.chunk, render_kwargs_test, savedir=savedir)
